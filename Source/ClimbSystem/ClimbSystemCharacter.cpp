...
AClimbSystemCharacter::AClimbSystemCharacter(const FObjectInitializer& ObjectInitializer)
	:Super(ObjectInitializer.SetDefaultSubobjectClass<UClimbMovementComponent>(ACharacter::CharacterMovementComponentName))
{
	MovementComponent = Cast<UClimbMovementComponent>(GetCharacterMovement());
...
void AClimbSystemCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AClimbSystemCharacter::Move);
...
void AClimbSystemCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AClimbSystemCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
